  ...
  return (
    <section className="bg-white py-20 lg:py-24">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        ...
        <h2 className="font-display text-3xl sm:text-4xl leading-[1.1] text-brand-dark max-w-xl mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {OFFICES.map((office, i) => (
            <Reveal
              key={office.state}
              delay={i * 100}
              className="bg-brand-cream p-6 flex flex-col"
            >
              ...
              <div className="mt-4 pt-4 border-t border-black/10 flex flex-col gap-1.5">
                <a
                  href={`tel:${office.phone.replace(/[^+\d]/g, "")}`}
                  className="text-[14px] text-brand-dark hover:text-brand-green-dark transition-colors"
                >
                  {office.phone}
                </a>
                <a
        ...
        <p className="mt-10 text-[13px] text-black/50">
